...
public class test {
    ...
    public static void menu_receita()
    {
        System.out.println("""
                ...
                ----------------------------
                ******* Selecione uma operação *******
                |  Opção 1 - Adicionar Receita |
                |  Opção 2 - Listar Receitas   |
                |  Opção 3 - Alterar Receita   |
                    ...
                    while (condicao)
                    {
                        System.out.println(lista_receita + """
                                ******* Selecione uma operação *******
                                ...
                                |  Opção 2 - Alterar serviço  |
                                |  Opção 3 - Alterar valor    |
                                |  Opção 4 - Alterar dia      |
                                |  Opção 5 - Alterar mes      |
                                |  Opção 6 - Voltar           |""");
                        ...
                        switch (operacao) {
                            case 1:
                                ...
                                System.out.println("""
                                        ******* Selecione uma operação *******
                                        |  Opção 1 - Fazer uma nova alteração  |
                                        |  Opção 2 - Alterar uma nova receita  |
                                        |  Opção 3 - Voltar                    |""");
                            ...
                            case 2:
                                ...
                                System.out.println("""
                                        ******* Selecione uma operação *******
                                        |  Opção 1 - Fazer uma nova alteração  |
                                        |  Opção 2 - Alterar uma nova conta    |
                                        |  Opção 3 - Voltar                    |""");
                    ...
                    switch (continuar)
                    {
                        case 1:
                            ...
                            System.out.println("""
                                    ...
                                    ******* Selecione uma operação *******
                                    |  Opção 1 - Fazer uma nova exclusão  |
                                    |  Opção 2 - Voltar                   |""");
    ...
    public static void menu_despesa()
    {
        System.out.println("""
                ...
                ----------------------------
                ******* Selecione uma operação *******
                |  Opção 1 - Adicionar Despesa |
                |  Opção 2 - Listar Despesas   |
                |  Opção 3 - Alterar Despesa   |
                |  Opção 4 - Excluir Despesa   |
                |  Opção 5 - Voltar            |
                |  Opção 6 - Sair              |""");
            ...
            for (Despesas lista_despesa : despesas)
            {
                if(opcao == lista_despesa.getId())
                {
                    while (condicao)
                    {
                        System.out.println(lista_despesa + """
                                ******* Selecione uma operação *******
                                |  Opção 1 - Alterar descrição     |
                                |  Opção 2 - Alterar tipo          |
                                |  Opção 3 - Alterar data          |
                                |  Opção 4 - Alterar valor         |
                                |  Opção 5 - Alterar pagamento     |
                                |  Opção 6 - Voltar                |""");
